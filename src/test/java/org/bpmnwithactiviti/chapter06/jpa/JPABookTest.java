package org.bpmnwithactiviti.chapter06.jpa;
...
@ContextConfiguration("classpath:diagrams/chapter06/jpa/jpa-application-context.xml")
public class JPABookTest {
	...
	public void executeJavaService(){
		...
		Book book = (Book) entityManager.createQuery("from Book b where b.title = ?").setParameter(1, "Activiti in Action").getSingleResult();
		assertNotNull(book);
